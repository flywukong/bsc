...
var (
	...
	snapshotDiskAccountReadMeter = metrics.NewRegisteredTimer("state/snapshot/disk/account/read", nil)
	snapshotDiskStorageReadMeter = metrics.NewRegisteredTimer("state/snapshot/disk/storage/read", nil)
