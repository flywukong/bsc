...
// SignSystemTx signs an unsigned system transaction with the validator's private key.
// Used in BidBlock (zero-simulate MEV) path: builder provides unsigned system txs, validator signs them.
