...
// accumulateWrites accumulates write KVs in memory until 256MB, then triggers batch write
...
// flushAccumulatedWrites performs a single 256MB batch write of accumulated writes
